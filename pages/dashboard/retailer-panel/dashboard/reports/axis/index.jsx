...
const Index = () => {
  ...
  function fetchTransactions(pageLink) {
    BackendAxios.get(pageLink || `/api/user/ledger/${transactionKeyword}?from=${Formik.values.from + (Formik.values.from && ("T" + "00:00"))}&to=${Formik.values.to+'T'+'23:59' ? new Date(new Date(Formik.values.to+'T'+'23:59').setHours(23,59,59,999)).toISOString() : new Date().toISOString()}&page=1`).then((res) => {
      setPagination({
